 ...
 *
 *   // network
 *   CThreadcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.threadcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CThreadcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CThreadcoinNetwork(UniValue objIn)
    {
...
// // can be under: ThreadcoinNetwork
// //   -- signature requirements : Key1(User)
// class CThreadcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == ThreadcoinNetwork);
//     // }
