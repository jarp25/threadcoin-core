...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ThreadcoinNetwork") type = ThreadcoinNetwork;
    if(strType == "ThreadcoinNetworkVariable") type = ThreadcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ThreadcoinNetwork) s = "ThreadcoinNetwork";
    if(type == ThreadcoinNetworkVariable) s = "ThreadcoinNetworkVariable";
