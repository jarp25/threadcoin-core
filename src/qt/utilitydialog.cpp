    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Threadcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Threadcoin Core"));
...
All the Threadcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 THRD, 0.1 THRD, 1 THRD and 10 THRD -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://threadcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://threadcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Threadcoin Core is shutting down...") + "<br /><br />" +
