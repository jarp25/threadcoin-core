    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Threadcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and threadcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Threadcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Threadcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Threadcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a threadcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Threadcoin Core help message to get a list with possible Threadcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Threadcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Threadcoin Core"); // default title
    ...
    // Append title to "Threadcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
