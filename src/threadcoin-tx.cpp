...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Threadcoin Core threadcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  threadcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded threadcoin transaction") + "\n" +
              "  threadcoin-tx [options] -create [commands]   " + _("Create hex-encoded threadcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded threadcoin transaction
